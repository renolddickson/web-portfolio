...
const Hero = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative h-[100vh] z-0"
      id="home"
    >
        ...
        <div className="flex flex-col md:flex-row items-center justify-center h-full">
          <div className="w-full md:w-1/2 space-y-4 md:space-y-6 text-center md:text-left">
            ...
            <div className="flex space-x-4 pt-4 justify-center md:justify-start">
              <button
                className="group relative px-6 py-2 border border-black bg-black text-white rounded-full transition duration-300 overflow-hidden cursor-pointer"
          ...
          <div className="w-full md:w-1/2 mt-12 md:mt-0 flex justify-center">
            <div className="relative w-full max-w-md">
              <div className="rounded-full bg-gray-200 p-4 md:p-8">
                <img src="/assets/hero-image.png" alt="Hero" className="w-full" />
              </div>
            </div>
          </div>
        </div>
